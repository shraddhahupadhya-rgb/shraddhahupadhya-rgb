...
// ─── ARRAYS ──────────────────────────────────────────────
char keywords[][20] = {"verify","secure","login","update","confirm","suspended", "alert", "urgent", "action", "attention", "restricted", "deactivated", "compromised", "fraud", "transaction", "invoice", "payment", "prize", "winner", "gift", "reward", "lucky", "congratulations", "blocked", "activity", "immediately", "account"};
int  weights[]      = { 15,      15,      10,     10,      10,       20,       10,      15,       10,       10,        15,           15,            20,          10,           10,          10,      15,      15,      15,     15,      15,              15,       15,        10,            15,           10 };
